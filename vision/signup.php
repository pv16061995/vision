    ...
    <div class="login-wrapper">
        ...
        <div class="box">
            ...
            <form action="" class="form-horizontal" id="signupForm" method="post" role="form">
             ...
             <input class="form-control"  id="Sending_Password" name="Sending_Password" placeholder="Sending Password" type="password" />
             <span class="field-validation-valid" for="Sending_Password"></span>

             <input  class="form-control" id="Confirm_Sending_Password" name="Confirm_Sending_Password" placeholder="Confirm Sending Password" type="password" />
             <span class="field-validation-valid" for="Confirm_Sending_Password"></span>

              <button class="btn btn-primary signup"><i class="fa fa-sign-in"></i>&nbsp;Signup</button>
            </form>
</div>
        </div>
