...
function accountbalances()
{
    ...
    $detail .='<table id="balanceTable" class="table table-striped table-hover table-condensed table-bordered display nowrap" >
        <thead>
            <tr>
                <th class="col-header col-header-option" style="min-width:78px; width:78px">Operations</th>
                <th class="col-header col-header-label" style="    width: 265px;    padding: 20px;">Currency Name</th>
...
function userresetpassword()
{
    ...
    echo $responseData['statusCode']."^".$responseData['message']."^".$responseData['userMailId'];
}
