$(document).ready(function(){
  ...
  $("#signupForm").validate({
    ...
    Password:
    {
      ...
      minlength:"The Password must be atleast 5 characters in length"
    }
    ,
    Confirm_Password:
    {
      required:"The Confirm Password field is required.",
      minlength:"The Confirm Password must be atleast 5 characters in length"
    },
    Sending_Password:
    {
      required:"The Transaction Password field is required.",
      minlength:"The Transaction Password must be atleast 5 characters in length"
    },
    Confirm_Sending_Password:
    {
      required:"The Confirm Transaction Password field is required.",
      minlength:"The Confirm Transaction Password must be atleast 5 characters in length"
    }
    }
    ,
    ...
    submitHandler: function(form) {
      ...
      $.post("ajax/ajax.php",{
        ...
        function(data){
          ...
          if(str[0]==200)
          {
            setTimeout(function(){window.location.href="verify_otp.php";},2000);
          }
        }
      );
    ...
    submitHandler: function(form) {
      ...
      $.post("ajax/ajax.php",{
        ...
        function(data){
          ...
          if(str[0]==200)
          {
            setTimeout(function(){window.location.href="update_password.php";},2000);
          }
        }
      );
