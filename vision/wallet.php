    ...
    <div id="accountbalances"></div>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-12 ">
                <h2 class="section-header-in-row">Withdraw</h2>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" data-toggle="tooltip" title="Deposit" >Deposit</h4>
            </div>
...
<div class='panel panel-default'>
    <div class='panel-heading'>
        <table style="width:100%">
            <tr>
                <td style="width: 30%; text-align:left">Withdraw <span data-bind="text: wallet.coinName"></span></td>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Deposit <span id="withdraw_currency3"></span> to this Address</h4>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Withdraw <span id="withdraw_currency4"></span> </h4>
            </div>
            <div class="modal-body">
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div id="getwithdraw"></div>
            ...
            <div class="col-sm-12">
                <button  type="button" class="btn btn-primary center-block" onclick="getwithdraw();"><i class="fa fa-cloud-upload"></i>&nbsp; Withdraw</button>
            </div>
        </form>
