...
<div class="login-wrapper">
    ...
    <div class="box">
        <div class="content-wrap">
          <form action="#" class="form-horizontal" id="otpForm" method="post" role="form">
            <h6>Verify OTP </h6>
            <input class="form-control" id="EmailAddress" name="EmailAddress" placeholder="Email Address" type="hidden" value="<?php echo $email ?>" />
            <span class="field-validation-valid"></span>

            <input class="form-control" id="otp" name="otp" placeholder="OTP" type="text" />
            <span class="field-validation-valid"></span><br/>
