...
div#successorderdetail1_filter {
    float: right;
}
    ...
    <div id="pad-wrapper">
        <div class="row">
            <div class="col-md-8 col-sm-12">
                <h2 class="section-header-in-row top-header"><?php echo $currencyname;?> Market</h2>
            </div>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <table style="width:100%">
            <tr>
                <td style="float:left;">Buy <?php echo $currency1;?></td>
                <td style="width: 70%; text-align: right">
                    <span id="balance_bid_able" ></span> <?php echo $currency2;?> Available
                </td>
            </tr>
        </table>
    </div>
        ...
        <form role='form' class="form-horizontal" method="post">
                ...
                <div class="col-md-12 controls">
                    <div class="input-group">
                        <span class="input-group-btn">
                            <button class="btn btn-primary" style="width:100px;" disabled="disabled" type="button">Units</button>
                        </span>
                        <input type="number" class="form-control text-right"  onkeypress="return isNumberKey(event)" value="" placeholder="0" onkeyup="bidAmount()" id="bid_vol" />

                        <span class="input-group-addon" ><?php echo $currency1;?></span>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-12 controls">
                    <div class="input-group">
                        <div class="input-group-btn">
                            <button type="button" style="width:100px;" class="btn btn-primary dropdown-toggle" disabled="disabled" data-toggle="dropdown">Price </button>

                        </div>
                        <input type="number" class="form-control text-right" id="bid_rate"  onkeypress="return isNumberKey(event)" onkeyup="bidAmount()" value="" placeholder="0" />
                        <span class="input-group-addon" ><?php echo $currency2;?></span>
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="input-group">
                        <div class="input-group-btn">
                            <button class="btn btn-default" style="width:100px;" type="button" disabled>Total</button>
                        </div>
                        <input type="text" class="form-control text-right" id="bid_amount" disabled="disabled"  onkeypress="return isNumberKey(event)" onkeydown="return check_number(event);" onkeyup="bidAmountTotal()" value="" placeholder="0" >
                        <span class="input-group-addon" ><?php echo $currency2;?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <button type="button" class="btn btn-primary center-block" style="width:200px; margin-top:10px;"  onclick="buy_data();">
                  <i class="fa fa-plus"></i>&nbsp; Buy <?php echo $currency1;?></button>
            </div>
             <div class="col-md-12">
...
<div class="panel panel-default">
    <div class="panel-heading">
        <table style="width:100%">
            <tr>
                <td style="float:left;">Sell <?php echo $currency1;?></td>
                <td style="width: 70%; text-align: right">
                    <span id="balance_ask_able" ></span> <?php echo $currency1;?> Available
                </td>
            </tr>
        </table>
    </div>
        ...
        <form role='form' class="form-horizontal" method="post">
            <div class="form-group">
                ...
                <div class="col-md-12 controls">
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control text-right" onkeypress="return isNumberKey(event)" onkeyup="askAmount()" value="" placeholder="0" id="ask_vol" />
                        <span class="input-group-addon" ><?php echo $currency1;?></span>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="input-group">
                        <div class="input-group-btn">
                            <button type="button" style="width:100px;" class="btn btn-primary dropdown-toggle"  disabled="disabled"  >Price </button>

                        </div>
                        <input type="number" class="form-control text-right"  onkeyup="askAmount()" onkeypress="return isNumberKey(event)" id="ask_rate" value="" placeholder="0" />
                        <span class="input-group-addon" ><?php echo $currency2;?></span>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                <button type="button" class="btn btn-primary center-block"  onclick="sell_data();" style="width:200px; margin-top:10px;"><i class="fa fa-minus"></i>&nbsp;Sell <?php echo $currency1;?></button>
            </div>
            <div class="col-md-12">
 ...
 <h2 class="section-header-in-row">Order Book</h2>
  ...
  <table id="bidOrdersTable" class="table table-striped table-hover table-condensed table-bordered left-table">
            ...
            <td  width="40%">Total(<?php echo $currency2;?>)</td>
            </tr>
            </thead>
    ...
    overflow-x:auto; overflow-y:hidden;padding-bottom: 17px;" >
...
<div class="datatables-wrapper">
  <div id="openmarketdetail"></div>
        ...
        <div class="row" id="rowTable">
            <!-- market history -->
            <div class="col-xs-12" id="orderSummary"  style="
    overflow-x:auto;overflow-y:hidden;padding-bottom: 17px;">
                <div class="row">
